                ...
                r = function (t) {
                    var a, e, m = (e = void 0, {
                            attributes: {
                                ...
                                excerpt: "<p>To see how any formula was written in any question or answer, including this one, right-click on the expression it and choose &quot;Show Math As &gt; TeX Commands&quot;. (When you do this, the '$' will not display. Make sure you add these. See the next point.)</p>\n",
                                createdAt: new Date(15555456e5),
                                updatedAt: new Date(1557219772013),
                                type: a,
                                permalink: "/mathpage.html"
                            },
                            internal: e,
                    ...
                    ["layout", "transition"].forEach(function (a) {
                        ...
                        e && (t.options[a] = e[a]), void 0 === t.options[a] && (t.options[a] = m.attributes[a])
                    }), t.options.name = "page-wrapper-" + m.attributes.slug.replace(/[^0-9a-z\-]/i, "-")
                },
